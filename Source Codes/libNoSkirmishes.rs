...
// #[skyline::hook(offset = 0x02B46A88, inline)]
// pub fn do_not_ignore_exist(ctx: &mut InlineCtx) {
//     unsafe { *ctx.registers[20].w.as_mut() = 0 }
// }

// #[skyline::hook(offset = 0x02B46A90, inline)]
// pub fn empty_gamespot_data(ctx: &mut InlineCtx) {
//     unsafe { *ctx.registers[0].x.as_mut() = 0 }
// }

// #[skyline::hook(offset = 0x02B40E20)]
// pub fn gamespot_get_spot_mob(this: Option<&GmapSpot>, method: OptionalMethod) -> i64 {
//     if this.is_some() {
...
pub fn is_check_dispos(this: i64, method: OptionalMethod) -> bool {
...
pub fn main() {
    ...
    skyline::install_hooks!(is_check_dispos);
}
