...
use engage::{battle::BattleCalculator, gamedata::unit::Unit};
use unity::prelude::*;
...
pub fn add_engage_count_1(calculator: &BattleCalculator, side: i32, method: OptionalMethod) {}

#[skyline::hook(offset = 0x024709D0)]
pub fn add_engage_count_2(calculator: &BattleCalculator, side: i32, method: OptionalMethod) {}

/// The internal name of your plugin. This will show up in crash logs. Make it 8 characters long at max.
#[skyline::main(name = "0EngageC")]
pub fn main() {
